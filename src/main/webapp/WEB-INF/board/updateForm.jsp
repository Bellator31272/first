...
<%-- 			<input type="hidden" name="pass" id="pass" value=${data.passwd } /> --%>
		<div class="container">
			<div class="text-center"><h3>게시판 입력화면</h3></div>
			<div class="form-group">
				<label for="author" class="col-sm-2 control-label">작성자</label>
				<div class="col-sm-10">
				<input type="text" class="form-control" id="author" name="author" readonly value=${data.author }  maxlength="20">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group" class="col-sm-2 control-label">
				...
				<div class="col-sm-10">
				<textarea rows="10" cols="10" class="form-control" style="resize: none" name="content" id="content" >${data.content }</textarea>
				</div>
			</div>
			<div class="form-group">
				<label for="passwd" class="col-sm-2 control-label">비밀번호</label>
				<div class="col-sm-10">
				<input type="password" class="form-control" id="passwd" name="passwd" placeholder="비밀번호 변경">
				</div>
			</div>
